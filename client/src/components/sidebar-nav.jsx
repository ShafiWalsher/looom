    ...
    return (
        <nav className="hidden fixed left-0 top-0 bg-white h-full w-20 md:flex flex-col items-center justify-between pt-6 pb-8">
            ...
            <div className="flex flex-col gap-2">
                <NavMenu onCreateClick={onCreateClick} iconSize={24} />
            </div>
            <div className=" hover:bg-gray-200 rounded-lg px-4 py-3.5 transition-colors duration-100 cursor-pointer group">
                <MenuIcon
